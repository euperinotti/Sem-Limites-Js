...
<head>
    ...
    <title>Atendimento ao Cliente | Sem Limites</title>
...
<header>
        <div id="container">
            ...
            <div id="container-right-side">
                <div id="profile-cart">
                    <a href="../user/<?php if(!$_SESSION['idusuario']){
                            echo 'login-page.php';
                        } else {
                    ...
                    <a href="../user/cart.php" target="_blank">
                        <div id="cart-icon">
                            <svg version="1.1" id="Camada_1" focusable="false" xmlns="http://www.w3.org/2000/svg"
...
<section id="support-section">
    <div class="support-container">
        ...
        <div class="support-text">
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam feugiat, erat non tincidunt tincidunt, elit neque fermentum nulla, id tristique dolor nisl tincidunt ante. Fusce justo dolor, laoreet tincidunt nisi in, convallis facilisis nulla. Ut vehicula consectetur purus a vehicula. Proin et eros a ligula scelerisque elementum. Curabitur blandit odio eu ante aliquam, blandit semper velit volutpat. Sed faucibus felis tellus, vitae condimentum justo consequat sed. Integer sit amet faucibus ipsum. Sed sagittis leo sit amet luctus convallis. Donec ornare, dolor vel accumsan auctor, libero libero ultricies nibh, bibendum sodales orci dui auctor ex. Quisque ornare sapien justo, laoreet suscipit velit tempus a. Ut egestas lorem a mauris fringilla, et congue odio malesuada. Mauris in iaculis odio. Aliquam id lobortis neque, sit amet semper nunc. <br><br>

            Nulla dapibus risus est, vel volutpat sem hendrerit a. Cras interdum nunc in lorem mattis vehicula. Phasellus condimentum, dolor in mollis viverra, lectus dolor aliquam lacus, vitae convallis augue sapien non ex. Proin ultrices erat a lacus dapibus vehicula. Nulla sagittis eros vitae porttitor facilisis. Nullam non diam sed quam finibus finibus. Orci varius natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Curabitur nulla libero, eleifend sit amet velit a, lobortis accumsan ex. Nulla facilisi. In hac habitasse platea dictumst. Maecenas est dui, placerat ut diam nec, interdum bibendum tellus. Cras gravida nisl eu sagittis dignissim. Vestibulum facilisis, mi sit amet finibus pharetra, elit velit viverra metus, in dignissim velit nulla in risus.</p>
        </div>
    </div>
</section>
            ...
            <div class="footer-left-side">
                ...
                <div class="footer-text-content">
                    <table class="table-suporte table-footer">
                        ...
                        <tbody>
                            <tr>
                                <td><a href="support.php">Atendimento ao cliente</a></td>
                            </tr>
                            <tr>
                                <td><a href="faq.php">Dúvidas frequentes</a></td>
                            </tr>
                            <tr>
                                <td><a href="table-sizes.php">Tabela de Tamanhos</a></td>
                            </tr>
                            <tr>
                                <td><a href="delivery-freight.php">Entregas e frete</a></td>
                            </tr>
                            <tr>
                                <td><a href="payment-options.php">Opções de pagamento</a></td>
                            </tr>
                            <tr>
                                <td><a href="refound.php">Troca e devolução</a></td>
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <table class="table-informacoes table-footer">
                        ...
                        <tbody>
                            <tr>
                                <td><a href="about-us.php">Sobre nós</a></td>
                            </tr>
                        </tbody>
                    </table>
