...
<head>
    ...
    <title>Dúvidas Frequentes | Sem Limites</title>
...
<section id="faq-section">
    <div class="faq-container">
        ...
        <div class="faq-box">
            <button class="acordeon">Como faço para mudar minha senha?</button>
            <div class="faqAnswer">
                <p>Para alterar sua senha basta seguir estes passos:</p>
                <ol>
                    <li>Faça login no site;</li>
                    <li>Acesse o seu perfil;</li>
                    <li>Clique sobre o botão "Editar Perfil";</li>
                    <li>Encontre o campo senha e o altere;</li>
                    <li>Clique sobre o botão "Salvar" e pronto!</li>
                </ol>
            </div>
        </div>
        
        <div class="faq-box"><button class="acordeon">Oque eu faço caso o produto esteja danificado?</button>
            <div class="faqAnswer">
                <p>Em caso de danos identificados ao produto ainda lacrado, entre em contato com a Sem Limites através do e-mail semlimites@outlook.com informando o problema e em seguida anexando uma foto do produto. Após isso a empresa irá verificar sua solicitação e caso aprovada você receberá seu dinheiro de volta.</p>
            </div></div>
    
        <div class="faq-box">
            <button class="acordeon">Como faço para comprar no site?</button>
            <div class="faqAnswer">
        ...
        <div class="faq-box">
            <button class="acordeon">Como faço alterações no carrinho?</button>
            <div class="faqAnswer">
                <p>"Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum."</p>
    </div>
        </div>
