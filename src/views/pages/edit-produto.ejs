...
<head>
    ...
    <title>Editar Produto | Sem Limites</title>
    <link rel="shortcut icon" type="image/x-icon" href="../icons/icon-tab-03.svg">
    <link rel="stylesheet" href="../css/header.css">
    <link rel="stylesheet" href="../css/edit-produto.css">
...
<section id="product-section">
    <h1 class="main-header">EDITAR INFORMAÇÕES</h1>
    <div class="product-data">
        <div class="pd-right">
        <form action="edit-produto.php?acc=update&id=<?php echo $produto['idproduto'];?>" method="POST" id="aap-form" enctype="multipart/form-data">
        <div class="form-section">
            <div id="register-product-basic" class="form-grid">
                    <div class="register-product-name-box box-display">
                            ...
                            placeholder="Nome" value="<?php echo $produto['nome'];?>" maxlength="45" required>
                    </div>
                    ...
                    <div class="register-product-color-box box-display">
                        ...
                        <input type="text" id="register-product-color" name="product-color" placeholder="Preto" value="<?php echo $produto['cor'];?>" maxlength="30" required>
                    </div>

                    <div class="register-qntd-box">
                            <label for="produto-estoque">Estoque</label>
                            <div class="produto-esotque-box">
                                <input type="number" value="<?php echo $produto['Estoque'];?>" id="produto-estoque" name="produto-estoque" />
                            </div>
                    </div>
    
                    <div class="register-product-price-box box-display">                  
                            <label for="register-product-price-box">Preço</label>
                            <input type="text" id="register-product-price-box" placeholder="80" maxlength="30" name="product-price" step="0.01" value="<?php echo $produto['preco'];?>" required>
                    </div>

                    <div class="register-product-discount-box box-display">                  
                            <label for="register-product-discount-box">Desconto</label>
                            <input type="number" id="register-product-discount-box" placeholder="10" maxlength="3" name="product-discount" value="<?php echo $produto['desconto'];?>" step="1" max="100" min="0" onkeydown="return false">
                    </div>
        ...
        <div class="form-section">
            ...
            <div id="register-product-description">
                        <textarea name="product-description" placeholder="Utilize (??) para quebra de linha."><?php echo $produto['descricao'];?></textarea>
            </div>
            ...
            <?php 
                if(isset($_GET['acc']) == "update"){
                    ...
                    $cor = filter_input(INPUT_POST, 'product-color');
                    $estoque = filter_input(INPUT_POST, 'produto-estoque');
                    $preco = filter_input(INPUT_POST, 'product-price');
                    ...
                    echo $nome . " " . $tamanho . " " . $cor . " " . $estoque . " " . $preco . " " . $categoria;

                    if($nome && $tamanho && $cor && $estoque && $preco && $categoria != ""){
                        ...
                        $stmt = $pdo->prepare("UPDATE produto SET nome = :nome, tamanho = :tamanho, cor = :cor, Estoque = :estoque, preco = :preco, desconto = :desconto, categoria = :categoria, Imagem = :imagem, descricao = :descricao WHERE idproduto = :idproduto");
                        ...
                        echo "ERRO AO ADICIONAR ATUALIZAR/RECEBER DADOS DO PRODUTO";
                }
                }
