...
<head>
    ...
    <title>Continuar Cadastro | Sem Limites</title>
    <link rel="shortcut icon" type="image/x-icon" href="../../icons/icon-tab-03.svg">
    <link rel="stylesheet" href="../../css/continue-register.css">
...
<section class="continue-register">
    <div class="register-headline">
        <h1>CADASTRO</h1>
    </div>
    <form action="../../php/validate_cliente.php" method="POST" id="registerForm">
        ...
        <div class="form-section">
            ...
            <div id="register-data" class="form-grid">
                    <div class="register-name-box box-display">
                            ...
                            placeholder="Nome"  maxlength="45" class="input-box-2" value="<?php $nome = $_POST ['register-first-name'];
                            echo $nome; ?>" required>
                    </div>

                    <div class="register-lastname-box box-display">
                            <label for="register-lastname">Sobrenome</label>
                            <input type="text" name="client-lastname" placeholder="Sobrenome" maxlength="45" class="input-box-2" value="<?php $sobrenome = $_POST ['register-last-name'];
                            echo $sobrenome; ?>" required>
                    </div>
                    ...
                    <div class="register-email-box box-display">
                            ...
                            <input type="email" placeholder="seu.email@exemplo.com" max="70" name="client-email" class="input-box-1" value="<?php $email = $_POST ['register-email'];
                            echo $email; ?>" required>
                    </div>
                    ...
                    <div class="register-ddd-box box-display">
                        ...
                        <input type="number" name="client-ddd" placeholder="045" maxlength="3" min="001" max="999"
                        step="1" class="input-box-4" required>
                    </div>
            ...
            <div id="register-address" class="form-grid">
                        ...
                        <div class="register-bairro-box register-box-type2">
                            ...
                            <div class="register-bairro-input">
                                <select id="register-bairro-select" class="input-box-2" name="client-bairro" form="registerForm">
