...
<head>
    ...
    <title>Entregas e Frete | Sem Limites</title>
    <link rel="shortcut icon" type="image/x-icon" href="../../icons/icon-tab-03.svg">
    <link rel="stylesheet" href="../../css/delivery-freight.css">
...
<section id="delivery-section">
    <div class="delivery-container">
        ...
        <div class="delivery-text">
            <p>Nossa maior prioridade é entregar o seu pedido o quanto antes, com qualidade e precisão. Ao finalizar o seu pedido, ele é colocado em análise, até que o administrador verifique o pagamento do pedido. Assim que feito, seu pedido é enviado para seu endereço.</p>
       
            <h3>Frete</h3>
            <p>Entregamos para todo o território municipal. Caso ocorra algum problema em sua localidade devido a fatores externos, entraremos em contato para tentar resolver da melhor maneira.</p>
            <p>O valor do frete é definido segundo o bairro de seu endereço. Segue abaixo uma tabela com todos os bairros da cidade e seus respectivos valores de frete.</p>
            ...
            <?php 
            $stmt = $pdo->prepare("SELECT * FROM frete");
            $stmt->execute();
            $frete = $stmt->fetchAll(PDO::FETCH_ASSOC);

            foreach($frete as $fr):
            ?>
                
                <tr>
                    <td><?php echo $fr['bairro']; ?></td>
                    <td><?php echo "R$ " . $fr['valor']; ?></td>
                </tr>
            <?php endforeach; ?>
            </tbody>
            </table>
            <p>Obs: O valor do frete é acrescentado automaticamente na sua compra.</p>
            
            <br>
            
            <h3>Previsão de entrega</h3>

            <p>A precisão de entrega gira em torno de 3 a 5 dias.</p>
            <br>

            <h3>Informações adicionais</h3>
            <ul>
                <li>Caso note qualquer índice de violação na embalagem no momento do recebimento, entre em contato conosco. A Sem Limites não é responsável por avarias ou perda de produtos que ocorrerem após a entrega no endereço informado na finalização do pedido.</li>
                <li>Caso nossa transportadora não consiga entregar o seu pedido por inconsistências cadastrais ou ausência de pessoa para receber o produto na data e local de entrega, entraremos em contato pelo e-mail cadastrado em sua conta.</li>
                <li>As entregas são realizadas apenas dentro de todo o território municipal.</li>
            </ul>
            <br>
