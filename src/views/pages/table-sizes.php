...
<head>
    ...
    <title>Tabela de Tamanhos | Sem Limites</title>
    <link rel="shortcut icon" type="image/x-icon" href="../../icons/icon-tab-03.svg">
    <link rel="stylesheet" href="../../css/table-sizes.css">
...
<section id="table-container">
    <div class="container-content">
            <div class="content-headline">
                <h1>TABELAS DE TAMANHOS</h1>
            </div>

            <div class="content-text">
                <div class="content-tie">
                    <h1>Tamanhos Masculinos</h1>
                    <h3>Tamanhos para calçados</h3>
                </div>
            ...
            <div class="content-text">
                <div class="content-tie">
                    <h1>Tamanhos Masculinos</h1>
                    <h3>Tamanhos para camisetas e jaquetas</h3>
                </div>
                <div class="content-table">
                    <table>
                        <thead>
            ...
            <div class="content-text">
                <div class="content-tie">
                    <h1>Tamanhos Masculinos</h1>
                    <h3>Tamanhos para calças e bermudas</h3>
                </div>
                <div class="content-table">
                    <table>
                        <thead>
