...
<head>
    ...
    <title>Trocas e devolução | Sem Limites</title>
...
<section id="refound-section">
    <div class="refound-container">
        <div class="refound-headline">
            <h1>TROCAS E DEVOLUÇÃO</h1>
        </div>
        <div class="refound-text">
            <h3>Como faço para trocar ou devolver um produto?</h3>
            <ol>
                <li>O produto a ser devolvido deverá estar sem uso em sua embalagem original.</li>
                <li>Caso seja identificada qualquer divergência ou violação do produto, não aceitaremos a devolução e entregaremos novamente o produto ao remetente .</li>
            </ol>

            <h3>Reembolso</h3>
            <p>A restituição dos valores pagos pelo cliente será de acordo com o metodo de pagamento escolhido no processo da compra inicial.</p>
 
            <p><strong>Importante:</strong> A restituição dos valores será processada somente após o recebimento e análise das condições do(s) produto(s). O produto não poderá trazer qualquer indício de uso.</p>
        </div>
    </div>
</section>
