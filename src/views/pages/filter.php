        ...
        <div id="container">
            <div id="container-left-side">
                ...
                <div id="header-options">
                    <ul>
                        <li><a href="male.php">PRODUTOS</a></li>
            ...
            <div id="container-right-side">
                ...
                <form action="male.php" method="GET" id="form-search-bar">
                    <div id="search-bar">
    ...
    <aside id="aside-menu">
        ...
        <div class="male-section-container">
            ...
            if(isset($_GET['filter'])){
                $tamanho = $_POST['aside-size'];
                $categoria = $_POST['aside-cate'];
                $preco = $_POST['aside-range'];

                if ($tamanho || $categoria || $preco != ""){
                    $stmtf = $pdo->prepare("SELECT * FROM produto WHERE tamanho = :tamanho AND preco <= :preco AND categoria = :categoria");
                    $stmtf->bindParam(':tamanho', $tamanho);
                    $stmtf->bindParam(':preco', $preco);
                    $stmtf->bindParam(':categoria', $categoria);
                    $stmtf->execute();

                    $filter = $stmtf->fetchAll(PDO::FETCH_ASSOC);
                    
                    if($stmtf->rowCount() > 0){
                    
                    foreach($filter as $fl): ?>
                        <a href="product-description.php?id=<?php echo $fl['idproduto'] . "&name=" . $fl['nome']; ?>">
                        <div class="male-section-box">
                            <div class="male-section-box-top">
                                <?php echo "<img src='../../images/produtos/" . $fl['Imagem'] . "'>";?>
                            </div>
                            <div class="male-section-box-bottom">
                                    <h1><?php echo $fl['nome'];?></h1>
                                    <span><?php echo "R$ " . $fl['preco'];?></span>
                            </div>
                        </div>  
                        </a>            
                    <?php endforeach; 
