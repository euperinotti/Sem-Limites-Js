...
$categoria = [];
$fk = $produto['categoria_idcategoria'];
$stmtc = $pdo->prepare("SELECT * FROM categoria WHERE idcategoria = :idcategoria");
$stmtc->bindValue(':idcategoria', $fk);
$stmtc->execute();
$categoria = $stmtc->fetch();
...
<head>
    ...
    <title><?php echo $produto['nome']; ?> | Sem Limites</title>
    ...
    <script src="../../js/hidden-menus.js" defer></script>
</head>
...
<div class="left-side">
    <div class="ls-image">
        <?php echo "<img src='../../images/produtos/" . $produto['Imagem'] . "'>";?>
    </div>
    ...
    <div class="rs-content">
        <div class="rs-header">
            <h4 class="type-gender">
                <?php
                    echo strtoupper($categoria['nome']); 
                ?>
            </h4>
            <h1><?php echo $produto['nome']; ?></h1>
            <h4 class="color"><?php echo strtoupper($produto['cor']); ?></h4>
        </div>
        <div class="rs-money">
        ...
        <div class="rs-sub-menu">
            <div class="sb-size">
               ...
               <button><?php echo $produto['tamanho']; ?></button>
            </div>
