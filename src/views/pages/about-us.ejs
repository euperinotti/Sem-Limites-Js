...
<head>
    ...
    <title>Sobre Nós | Sem Limites</title>
...
<section id="about-us-section">
    <div class="about-us-container">
        ...
        <div class="about-us-text">
            <h2>Origem</h2>
            <p>Sem Limites é uma empresa originada em Cascavel - PR no ano de 2020. O nome "Sem Limites" tem um significado de imparável,
                incansável e refere-se à aqueles(as) que não desistem de seus objetivos, por conta disso a empresa
                busca fornecer a melhor tecnologia e comforto para que seus usários se sintam aptos a realizar suas
                atividades.</p>
            <br>

            <h2>Lojas</h2>
            <p>Atualmente a Sem Limites possui apenas uma loja física localizada na Rua Xavantes 1777 - Bairro Santa
                Cruz - Cascavel, PR.</p>
        </div>
    </div>
</section>
